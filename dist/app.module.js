...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, auth_module_1.AuthModule, usuarios_module_1.UsuariosModule, organizacao_module_1.OrganizacaoModule, admins_module_1.AdminsModule],
        controllers: [],
        providers: [],
    })
], AppModule);
